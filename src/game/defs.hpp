...
enum CriticalSection
{
    ...
    CRITSECT_RD_BUFFER = 0x12,
    CRITSECT_SYS_EVENT_QUEUE = 0x13,
    CRITSECT_GPU_FENCE = 0x14,
    CRITSECT_FATAL_ERROR = 0x15,
    CRITSECT_MISSING_ASSET = 0x16,
    CRITSECT_PHYSICS = 0x17,
    CRITSECT_LIVE = 0x18,
    CRITSECT_AUDIO_PHYSICS = 0x19,
    CRITSECT_LSP = 0x1A,
    CRITSECT_CINEMATIC_UPDATE = 0x1B,
    CRITSECT_CINEMATIC_TARGET_CHANGE_COMMAND = 0x1C,
    CRITSECT_CINEMATIC_TARGET_CHANGE_BACKEND = 0x1D,
    CRITSECT_CINEMATIC_STATUS = 0x1E,
    CRITSECT_CINEMATIC_SERVER = 0x1F,
    CRITSECT_FX_ALLOC = 0x20,
    CRITSECT_CBUF = 0x21,
    CRITSECT_STATS_WRITE = 0x22,
    CRITSECT_CG_GLASS = 0x23,
    CRITSECT_SERVER_DEMO_COMPRESS = 0x24,
    CRITSECT_COM_SET_ERROR_MSG = 0x25,
    CRITSECT_SOUND_UPDATE = 0x26,
    CRITSECT_RESET_MODEL_LIGHTING = 0x27,
    CRITSECT_COUNT = 0x28,
};
